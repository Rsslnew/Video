...
async def start_me(bot, update):
    ...
    if update_channel:
        try:
            user = await bot.get_chat_member(update_channel, update.chat.id)
            if user.status == "kicked":
               await update.reply_text(" Sorry,You've Been Flooding Me So My Owner Removed You From Using Me If You Think It's An Error Contact : @movieskacona")
               return
        except UserNotParticipant:
            await update.reply_text(
                text="**Due To The Huge Traffic Only Channel Members Can Use This Bot Means You Need To Join The Below Mentioned Channel Before Using Me!An Bot by @movieskacona **",
                reply_markup=InlineKeyboardMarkup([
                    [ InlineKeyboardButton(text="Join My Updates Channel", url=f"https://t.me/{update_channel}")]
              ])
            )
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/opleecher'),
                    InlineKeyboardButton('Feedback', url='https://t.me/movieskacona')
                ],
                [
                    InlineKeyboardButton('Other Bots', url='https://t.me/movieskacona'),
                    InlineKeyboardButton('Source', url='https://github.com/Darkfur2340/Darks-Rename-File-to-Video-Converter-Bot')
                ]
            ]
        ),
